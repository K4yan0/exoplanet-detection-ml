...
from train_exp10a import TransformerBlock, TokenAndPositionEmbedding, ClassToken
...
def main():
    print("--- Exp 10A (Self-Attention + CLS Token) Full Evaluation ---")
    ...
    model = tf.keras.models.load_model(
        'data/models/exp10a_model.keras',
        custom_objects={
