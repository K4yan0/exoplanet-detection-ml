...
MODEL_SAVE_PATH = 'data/models/exp6_native_mad_model.keras'
MANIFEST_PATH = 'docs/exp6_reproducibility_manifest.json'
...
def main():
    print("==================================================")
    print("TRAINING EXP 6 NATIVE MAD CNN")
    print("==================================================")
    ...
    # 2. Apply MAD Normalization (Experimental Intervention)
    print("Applying MAD normalization...")
    ...
    # 3. Strict Train/Validation Split (Identical to Exp 5)
    ...
    manifest = {
        ...
        "dataset": {
            ...
            "normalization": "median absolute deviation (MAD)"
        },
        "model": {
