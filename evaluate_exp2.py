...
def main():
    ...
    plt.title('Ternary Confusion Matrix (Exp 2 - MAD Scaling)')
    plt.ylabel('Actual True Label')
    plt.xlabel('Predicted Label')
    plt.tight_layout()
    os.makedirs(os.path.join('docs', 'assets'), exist_ok=True)
    plt.savefig(os.path.join('docs', 'assets', 'v2_exp2_cm.png'))
    plt.close()
    
    print("Generating Report...")
    markdown_content = f"""# V2_EXP2_001
...
## Artifacts
![Confusion Matrix](assets/v2_exp2_cm.png)
...
"""
    with open('docs/V2_EXP2_001.md', 'w') as f:
        f.write(markdown_content)
        
    print("Exp2 evaluation complete. Saved to docs/V2_EXP2_001.md")
